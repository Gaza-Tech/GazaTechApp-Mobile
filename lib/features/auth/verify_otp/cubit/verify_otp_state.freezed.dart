...
@override
String toString() {
  return 'VerifyOtpState.success(message: $message)';
}
...
class Failure implements VerifyOtpState {
...
/// @nodoc
abstract mixin class $FailureCopyWith<$Res> implements $VerifyOtpStateCopyWith<$Res> {
