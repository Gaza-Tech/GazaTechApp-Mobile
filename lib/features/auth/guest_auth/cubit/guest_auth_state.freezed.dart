...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GuestAuthState);
}
...
/// @nodoc
class $GuestAuthStateCopyWith<$Res>  {
$GuestAuthStateCopyWith(GuestAuthState _, $Res Function(GuestAuthState) __);
}


/// Adds pattern-matching-related methods to [GuestAuthState].
extension GuestAuthStatePatterns on GuestAuthState {
...
class _Initial implements GuestAuthState {
  const _Initial();
...
class Loading implements GuestAuthState {
  const Loading();
...
class Success implements GuestAuthState {
  const Success();
...
class Failure implements GuestAuthState {
  const Failure(this.message);
  

 final  String message;

/// Create a copy of GuestAuthState
...
@override
String toString() {
  return 'GuestAuthState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<$Res> implements $GuestAuthStateCopyWith<$Res> {
