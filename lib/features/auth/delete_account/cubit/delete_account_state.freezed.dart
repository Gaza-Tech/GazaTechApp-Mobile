...
class _Initial implements DeleteAccountState {
  const _Initial();
...
class _Loading implements DeleteAccountState {
  const _Loading();
...
class _Success implements DeleteAccountState {
...
@override
String toString() {
  return 'DeleteAccountState.success(message: $message)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $DeleteAccountStateCopyWith<$Res> {
...
class _Failure implements DeleteAccountState {
...
@override
String toString() {
  return 'DeleteAccountState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $DeleteAccountStateCopyWith<$Res> {
