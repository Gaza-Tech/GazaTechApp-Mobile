...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GoogleAuthState);
}
...
/// @nodoc
class $GoogleAuthStateCopyWith<$Res>  {
$GoogleAuthStateCopyWith(GoogleAuthState _, $Res Function(GoogleAuthState) __);
}
...
class _Initial implements GoogleAuthState {
  const _Initial();
...
class Loading implements GoogleAuthState {
  const Loading();
...
class Success implements GoogleAuthState {
  const Success();
...
class Cancelled implements GoogleAuthState {
  const Cancelled();
...
@override
String toString() {
  return 'GoogleAuthState.cancelled()';
}
...
class Failure implements GoogleAuthState {
...
/// @nodoc
abstract mixin class $FailureCopyWith<$Res> implements $GoogleAuthStateCopyWith<$Res> {
