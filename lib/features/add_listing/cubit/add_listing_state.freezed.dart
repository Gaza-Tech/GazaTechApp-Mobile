...
// Form data from DB
 List<CategoryModel> get categories; List<LocationModel> get locations; bool get isLoadingFormData;// Submission
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(categories),const DeepCollectionEquality().hash(locations),isLoadingFormData,isSubmitting,submitSuccess,errorMessage);

@override
String toString() {
  return 'AddListingState(categories: $categories, locations: $locations, isLoadingFormData: $isLoadingFormData, isSubmitting: $isSubmitting, submitSuccess: $submitSuccess, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 List<CategoryModel> categories, List<LocationModel> locations, bool isLoadingFormData, bool isSubmitting, bool submitSuccess, String? errorMessage
});
...
/// Create a copy of AddListingState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? categories = null,Object? locations = null,Object? isLoadingFormData = null,Object? isSubmitting = null,Object? submitSuccess = null,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<CategoryModel> categories,  List<LocationModel> locations,  bool isLoadingFormData,  bool isSubmitting,  bool submitSuccess,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AddListingState() when $default != null:
return $default(_that.categories,_that.locations,_that.isLoadingFormData,_that.isSubmitting,_that.submitSuccess,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<CategoryModel> categories,  List<LocationModel> locations,  bool isLoadingFormData,  bool isSubmitting,  bool submitSuccess,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _AddListingState():
return $default(_that.categories,_that.locations,_that.isLoadingFormData,_that.isSubmitting,_that.submitSuccess,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<CategoryModel> categories,  List<LocationModel> locations,  bool isLoadingFormData,  bool isSubmitting,  bool submitSuccess,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _AddListingState() when $default != null:
return $default(_that.categories,_that.locations,_that.isLoadingFormData,_that.isSubmitting,_that.submitSuccess,_that.errorMessage);case _:
  return null;
...
class _AddListingState implements AddListingState {
  const _AddListingState({final  List<CategoryModel> categories = const [], final  List<LocationModel> locations = const [], this.isLoadingFormData = false, this.isSubmitting = false, this.submitSuccess = false, this.errorMessage}): _categories = categories,_locations = locations;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_categories),const DeepCollectionEquality().hash(_locations),isLoadingFormData,isSubmitting,submitSuccess,errorMessage);
...
/// Create a copy of AddListingState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? categories = null,Object? locations = null,Object? isLoadingFormData = null,Object? isSubmitting = null,Object? submitSuccess = null,Object? errorMessage = freezed,}) {
