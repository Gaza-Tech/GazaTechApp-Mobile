...
@JsonKey(name: 'location_id') String get locationId; String get name;@JsonKey(name: 'name_ar') String? get nameAr; String get slug;@JsonKey(name: 'is_active') bool get isActive;@JsonKey(name: 'sort_order') int? get sortOrder;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,locationId,name,nameAr,slug,isActive,sortOrder);

@override
String toString() {
  return 'LocationModel(locationId: $locationId, name: $name, nameAr: $nameAr, slug: $slug, isActive: $isActive, sortOrder: $sortOrder)';
}
...
@useResult
$Res call({
@JsonKey(name: 'location_id') String locationId, String name,@JsonKey(name: 'name_ar') String? nameAr, String slug,@JsonKey(name: 'is_active') bool isActive,@JsonKey(name: 'sort_order') int? sortOrder
});
...
/// Create a copy of LocationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? locationId = null,Object? name = null,Object? nameAr = freezed,Object? slug = null,Object? isActive = null,Object? sortOrder = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'location_id')  String locationId,  String name, @JsonKey(name: 'name_ar')  String? nameAr,  String slug, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'sort_order')  int? sortOrder)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LocationModel() when $default != null:
return $default(_that.locationId,_that.name,_that.nameAr,_that.slug,_that.isActive,_that.sortOrder);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'location_id')  String locationId,  String name, @JsonKey(name: 'name_ar')  String? nameAr,  String slug, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'sort_order')  int? sortOrder)  $default,) {final _that = this;
switch (_that) {
case _LocationModel():
return $default(_that.locationId,_that.name,_that.nameAr,_that.slug,_that.isActive,_that.sortOrder);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'location_id')  String locationId,  String name, @JsonKey(name: 'name_ar')  String? nameAr,  String slug, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'sort_order')  int? sortOrder)?  $default,) {final _that = this;
switch (_that) {
case _LocationModel() when $default != null:
return $default(_that.locationId,_that.name,_that.nameAr,_that.slug,_that.isActive,_that.sortOrder);case _:
  return null;
...
class _LocationModel implements LocationModel {
  const _LocationModel({@JsonKey(name: 'location_id') required this.locationId, required this.name, @JsonKey(name: 'name_ar') this.nameAr, required this.slug, @JsonKey(name: 'is_active') this.isActive = true, @JsonKey(name: 'sort_order') this.sortOrder});
...
/// Create a copy of LocationModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? locationId = null,Object? name = null,Object? nameAr = freezed,Object? slug = null,Object? isActive = null,Object? sortOrder = freezed,}) {
